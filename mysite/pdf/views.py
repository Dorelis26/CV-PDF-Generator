...
def accept(request):
    if request.method == "POST":
        ...
        profile = Profile(name=name,email=email,phone=phone,summary=summary,degree=degree,education=education,university=university,previous_experience=previous_experience,skills=skills)
        profile.save()
